...
{%- set schema_name, insights_table_name, convtype_table_name = 'googleads_raw', 'ad_group_performance_report', 'ad_group_convtype_performance_report' -%}
...
LEFT JOIN convtype USING(date, ad_group_id)
{%- endif %}
{% if is_incremental() -%}
